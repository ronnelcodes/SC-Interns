!(function (a, b) {
      ...
      if (g[i]) {
        if (b && (d = c ? g[i] : g[i].data)) {
          kb.isArray(b)
            ...
            : b in d
            ? (b = [b])
            : ((b = kb.camelCase(b)), (b = b in d ? [b] : b.split(" "))),
            (e = b.length);
          for (; e--; ) delete d[b[e]];
  ...
  function o(a, b) {
    return kb.nodeName(a, "table") &&
      kb.nodeName(1 === b.nodeType ? b : b.firstChild, "tr")
  ...
  function w(a, b) {
    if (b in a) return b;
    for (
      var c = b.charAt(0).toUpperCase() + b.slice(1), d = b, e = yc.length;
      e--;
        ...
        d.style &&
          ...
          b
            ? (f[g] || "none" !== c || (d.style.display = ""),
              "" === d.style.display &&
                x(d) &&
                (f[g] = kb._data(d, "olddisplay", C(d.nodeName))))
            : f[g] ||
              ((e = x(d)),
              ((c && "none" !== c) || !e) &&
  ...
  function A(a, b, c, d, e) {
    for (
      ...
      "margin" === c && (g += kb.css(a, c + xc[f], !0, e)),
        d
          ? ("content" === c && (g -= kb.css(a, "padding" + xc[f], !0, e)),
            "margin" !== c &&
              (g -= kb.css(a, "border" + xc[f] + "Width", !0, e)))
    ...
    return (
      c ||
        ...
        ("none" !== c && c) ||
          ((jc = (
            jc ||
            kb("<iframe frameborder='0' width='0' height='0'/>").css(
              "cssText",
  ...
  function N(a, b, c) {
    for (
      var d, e = (ed[b] || []).concat(ed["*"]), f = 0, g = e.length;
      g > f;
      f++
    )
  ...
  function Q(a, b, c) {
    ...
    c.queue ||
      ...
      1 === a.nodeType &&
        ...
        "inline" === kb.css(a, "display") &&
          "none" === kb.css(a, "float") &&
          (kb.support.inlineBlockNeedsLayout && "inline" !== C(a.nodeName)
            ? (l.zoom = 1)
    ...
    for (d in b)
      if (((e = b[d]), ad.exec(e))) {
        if (
          (delete b[d], (f = f || "toggle" === e), e === (m ? "hide" : "show"))
        )
          continue;
  ...
  var U,
    ...
    yb = function () {
      Y.addEventListener
        ? (Y.removeEventListener("DOMContentLoaded", xb, !1),
          a.removeEventListener("load", xb, !1))
        : (Y.detachEvent("onreadystatechange", xb),
  ...
  (kb.fn = kb.prototype = {
    ...
    init: function (a, c, d) {
      ...
      if ("string" == typeof a) {
        ...
        if (e[1]) {
          if (
            ((c = c instanceof kb ? c[0] : c),
            kb.merge(
              this,
              kb.parseHTML(e[1], c && c.nodeType ? c.ownerDocument || c : Y, !0)
            ),
            ...
            (a = h[e]),
              ...
              h !== d &&
                (k && d && (kb.isPlainObject(d) || (c = kb.isArray(d)))
                  ? (c
                      ? ((c = !1), (g = a && kb.isArray(a) ? a : []))
                      : (g = a && kb.isPlainObject(a) ? a : {}),
                    (h[e] = kb.extend(k, g, d)))
                  : d !== b && (h[e] = d));
      return h;
    }),
    kb.extend({
      ...
      noConflict: function (b) {
        return (
          a.$ === kb && (a.$ = _), b && a.jQuery === kb && (a.jQuery = $), kb
        );
      },
      isReady: !1,
      readyWait: 1,
      ...
      parseJSON: function (c) {
        return a.JSON && a.JSON.parse
          ...
          : "string" == typeof c &&
            ((c = kb.trim(c)),
            c && qb.test(c.replace(sb, "@").replace(tb, "]").replace(rb, "")))
          ? Function("return " + c)()
      ...
      makeArray: function (a, b) {
        ...
        return (
          null != a &&
            (c(Object(a))
              ? kb.merge(d, "string" == typeof a ? [a] : a)
              : eb.call(d, a)),
          d
        );
      },
      ...
      function l(a, b) {
        var c = b && a,
          d =
            ...
            1 === a.nodeType &&
            1 === b.nodeType &&
            (~b.sourceIndex || _) - (~a.sourceIndex || _);
        if (d) return d;
      ...
      function p(a, b) {
        ...
        for (h = a, i = [], j = D.preFilter; h; ) {
          (!d || (e = pb.exec(h))) &&
            ...
            (e = qb.exec(h)) &&
              ((d = e.shift()),
              f.push({ value: d, type: e[0].replace(ob, " ") }),
              (h = h.slice(d.length)));
          for (g in D.filter)
            !(e = vb[g].exec(h)) ||
              (j[g] && !(e = j[g](e))) ||
      ...
      function y(a, b, c, d) {
        ...
        if (!d && 1 === j.length) {
          if (
            ...
            if (
              ((b = (D.find.ID(g.matches[0].replace(Bb, Cb), b) || [])[0]), !b)
            )
              return c;
            a = a.slice(f.shift().value.length);
          }
          for (
            e = vb.needsContext.test(a) ? 0 : f.length;
            e-- && ((g = f[e]), !D.relative[(h = g.type)]);

          )
            if (
              (i = D.find[h]) &&
              (d = i(
                g.matches[0].replace(Bb, Cb),
                (rb.test(f[0].type) && b.parentNode) || b
              ))
            ) {
            ...
            ? ((K = c),
              ...
              (Z = L.compareDocumentPosition
                ? function (a, b) {
                    ...
                    return d
                      ? 1 & d ||
                        (!B.sortDetached && b.compareDocumentPosition(a) === d)
                        ? a === c || Q(S, a)
                          ? -1
                          : b === c || Q(S, b)
                          ? 1
  ...
  kb.extend({
    ...
    hasData: function (a) {
      return (
        (a = a.nodeType ? kb.cache[a[kb.expando]] : a[kb.expando]), !!a && !h(a)
      );
    },
    data: function (a, b, c) {
      return e(a, b, c);
    ...
    kb.fn.extend({
      data: function (a, c) {
        ...
        if (a === b) {
          if (
            this.length &&
            ((f = kb.data(i)), 1 === i.nodeType && !kb._data(i, "parsedAttrs"))
          ) {
            for (d = i.attributes; d.length > h; h++)
              (e = d[h].name),
                0 === e.indexOf("data-") &&
                  ((e = kb.camelCase(e.slice(5))), g(i, e, f[e]));
  ...
  kb.fn.extend({
      ...
      if (i)
        for (b = (a || "").match(mb) || []; h > g; g++)
          if (
            ...
            (d =
              1 === c.nodeType &&
              (c.className ? (" " + c.className + " ").replace(Eb, " ") : " ")))
          ) {
            for (f = 0; (e = b[f++]); )
              0 > d.indexOf(" " + e + " ") && (d += e + " ");
      ...
      return this.each(
        kb.isFunction(a)
          ...
          : function () {
              if ("string" === c)
                for (
                  var e, f = 0, g = kb(this), h = b, i = a.match(mb) || [];
                  (e = i[f++]);
                ...
                (c === W || "boolean" === c) &&
                  (this.className &&
                    kb._data(this, "__className__", this.className),
                  (this.className =
                    this.className || a === !1
                      ? ""
    ...
    hasClass: function (a) {
      for (var b = " " + a + " ", c = 0, d = this.length; d > c; c++)
        if (
          1 === this[c].nodeType &&
          (" " + this[c].className + " ").replace(Eb, " ").indexOf(b) >= 0
        )
          return !0;
      return !1;
    },
        ...
        ? ((e = kb.isFunction(a)),
          this.each(function (c) {
            ...
            1 === this.nodeType &&
              ...
              (d =
                kb.valHooks[this.type] ||
                kb.valHooks[this.nodeName.toLowerCase()]),
              (d && "set" in d && d.set(this, f, "value") !== b) ||
                (this.value = f));
          }))
        : f
        ? ((d = kb.valHooks[f.type] || kb.valHooks[f.nodeName.toLowerCase()]),
    ...
    kb.extend({
      valHooks: {
        ...
        select: {
          get: function (a) {
            for (
              ...
              if (
                ...
                !(
                  (!c.selected && i !== e) ||
                  (kb.support.optDisabled
                    ? c.disabled
                    : null !== c.getAttribute("disabled")) ||
                  (c.parentNode.disabled &&
                    kb.nodeName(c.parentNode, "optgroup"))
                ))
              ) {
          ...
          set: function (a, b) {
            for (
              var c, d, e = a.options, f = kb.makeArray(b), g = e.length;
              g--;
        ...
        return a && 3 !== g && 8 !== g && 2 !== g
          ? typeof a.getAttribute === W
            ...
            : ((1 === g && kb.isXMLDoc(a)) ||
                ((c = c.toLowerCase()),
                (e =
                  kb.attrHooks[c] || (kb.expr.match.bool.test(c) ? Db : Cb))),
              d === b
    ...
    Jb ||
      ...
      (kb.expr.attrHandle.id = kb.expr.attrHandle.name = kb.expr.attrHandle.coords = function (
        a,
        c,
        d
      ) {
  ...
  (kb.event = {
    ...
    trigger: function (c, d, e, f) {
      ...
      if (
        ...
        if (!f && !k.noBubble && !kb.isWindow(e)) {
          for (
            j = k.delegateType || o, Ob.test(j + o) || (i = i.parentNode);
            i;
            i = i.parentNode
          )
            n.push(i), (l = i);
        ...
        for (m = 0; (i = n[m++]) && !c.isPropagationStopped(); )
          (c.type = m > 1 ? j : k.bindType || o),
            (g =
              (kb._data(i, "events") || {})[c.type] && kb._data(i, "handle")),
            g && g.apply(i, d),
            (g = h && i[h]),
            g &&
              kb.acceptData(i) &&
    ...
    dispatch: function (a) {
      ...
      if (
        ...
        for (
          h = kb.event.handlers.call(this, a, j), c = 0;
          ...
          for (
            ...
            (!a.namespace_re || a.namespace_re.test(e.namespace)) &&
              ...
              (a.data = e.data),
              (d = (
                (kb.event.special[e.origType] || {}).handle || e.handler
              ).apply(f.elem, i)),
              d !== b &&
                (a.result = d) === !1 &&
    ...
    kb.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function (
      a,
      b
    ) {
      kb.event.special[a] = {
      ...
      (kb.event.special.submit = {
        setup: function () {
          return kb.nodeName(this, "form")
            ? !1
            : (kb.event.add(this, "click._submit keypress._submit", function (
                a
              ) {
                var c = a.target,
                  d =
                    kb.nodeName(c, "input") || kb.nodeName(c, "button")
                      ? c.form
                      : b;
                d &&
        ...
        postDispatch: function (a) {
          a._submit_bubble &&
            ...
            this.parentNode &&
              !a.isTrigger &&
              kb.event.simulate("submit", this.parentNode, a, !0));
        },
        teardown: function () {
          return kb.nodeName(this, "form")
            ? !1
                ...
                Lb.test(b.nodeName) &&
                  ...
                  (kb.event.add(b, "change._change", function (a) {
                    !this.parentNode ||
                      a.isSimulated ||
                      a.isTrigger ||
                      kb.event.simulate("change", this.parentNode, a, !0);
                  }),
  ...
  kb.fn.extend({
    find: function (a) {
      ...
      return (
        (c = this.pushStack(e > 1 ? kb.unique(c) : c)),
    ...
    is: function (a) {
      return !!m(this, "string" == typeof a && Sb.test(a) ? kb(a) : a || [], !1)
        .length;
    },
    closest: function (a, b) {
      for (
        var c,
          ...
          e = this.length,
          f = [],
          g = Sb.test(a) || "string" != typeof a ? kb(a, b || this.context) : 0;
        e > d;
        d++
      )
    ...
    index: function (a) {
      return a
        ? "string" == typeof a
          ...
          : kb.inArray(a.jquery ? a[0] : a, this)
      ...
      function (a, b) {
        kb.fn[a] = function (c, d) {
          ...
          return (
            ...
            this.length > 1 &&
              (Tb[a] || (e = kb.unique(e)), Rb.test(a) && (e = e.reverse())),
            this.pushStack(e)
          );
        };
      }
  ...
  (gc.optgroup = gc.option),
    ...
    kb.fn.extend({
      ...
      remove: function (a, b) {
        for (
          var c, d = a ? kb.filter(a, this) : this, e = 0;
          null != (c = d[e]);
          e++
        )
          b || 1 !== c.nodeType || kb.cleanData(u(c)),
            c.parentNode &&
              (b && kb.contains(c.ownerDocument, c) && r(u(c, "script")),
            ...
            if (
              ...
              try {
                for (; e > d; d++)
                  (c = this[d] || {}),
                    1 === c.nodeType &&
                      (kb.cleanData(u(c, !1)), (c.innerHTML = a));
                c = 0;
              } catch (f) {}
            }
      ...
      domManip: function (a, b, c) {
        ...
        if (
          o ||
          (!(1 >= k || "string" != typeof n || kb.support.checkClone) &&
            cc.test(n))
        )
        ...
        if (
          k &&
          ((i = kb.buildFragment(a, this[0].ownerDocument, !1, !c && this)),
          (d = i.firstChild),
          ...
          for (g = kb.map(u(i, "script"), p), f = g.length; k > j; j++)
            (e = i),
              j !== m &&
                ((e = kb.clone(e, !0, !0)), f && kb.merge(g, u(e, "script"))),
              b.call(this[j], e, j);
          if (f)
            for (
              h = g[g.length - 1].ownerDocument, kb.map(g, q), j = 0;
              f > j;
              j++
            )
              (e = g[j]),
                dc.test(e.type || "") &&
                  !kb._data(e, "globalEval") &&
                  kb.contains(h, e) &&
                  (e.src
                    ? kb._evalUrl(e.src)
                    : kb.globalEval(
    ...
    kb.extend({
      clone: function (a, b, c) {
        ...
        if (
          ...
          !Wb.test("<" + a.nodeName + ">")
            ? (f = a.cloneNode(!0))
            : ((ic.innerHTML = a.outerHTML),
              ic.removeChild((f = ic.firstChild))),
          !(
            (kb.support.noCloneEvent && kb.support.noCloneChecked) ||
      ...
      buildFragment: function (a, b, c, d) {
          ...
          if (((f = a[p]), f || 0 === f))
            if ("object" === kb.type(f)) kb.merge(o, f.nodeType ? [f] : f);
              ...
              for (
                ...
                h = h.lastChild;
              if (
                (!kb.support.leadingWhitespace &&
                  Xb.test(f) &&
                  o.push(b.createTextNode(Xb.exec(f)[0])),
                !kb.support.tbody)
              )
                for (
                  f =
                  ...
                  kb.nodeName((j = f.childNodes[e]), "tbody") &&
                    !j.childNodes.length &&
                    f.removeChild(j);
              for (
                kb.merge(o, h.childNodes), h.textContent = "";
                h.firstChild;
        ...
        for (
          ...
          if (
            (!d || -1 === kb.inArray(f, d)) &&
            ((g = kb.contains(f.ownerDocument, f)),
    ...
    kb.extend({
      ...
      style: function (a, c, d, e) {
        if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
          var f,
            ...
            j = a.style;
          if (
            ((c = kb.cssProps[i] || (kb.cssProps[i] = w(j, i))),
          ...
          if (
            ...
            "string" === g &&
              (f = tc.exec(d)) &&
              ((d = (f[1] + 1) * f[2] + parseFloat(kb.css(a, c))),
              (g = "number")),
            !(
              null == d ||
              ("number" === g && isNaN(d)) ||
              ("number" !== g || kb.cssNumber[i] || (d += "px"),
              kb.support.clearCloneStyle ||
                "" !== d ||
      ...
      css: function (a, c, d, e) {
        ...
        return (
          ...
          "" === d || d
            ? ((f = parseFloat(g)), d === !0 || kb.isNumeric(f) ? f || 0 : g)
            : g
        );
      },
    }),
          ...
          return z(
            ...
            d
              ? A(
                  ...
                  c,
                  d,
                  kb.support.boxSizing &&
                    "border-box" === kb.css(a, "boxSizing", !1, e),
                  e
                )
              : 0
          );
    ...
    kb.support.opacity ||
      (kb.cssHooks.opacity = {
        ...
        set: function (a, b) {
          ...
          (c.zoom = 1),
            ((b >= 1 || "" === b) &&
              "" === kb.trim(f.replace(mc, "")) &&
              c.removeAttribute &&
              (c.removeAttribute("filter"), "" === b || (d && !d.filter))) ||
              (c.filter = mc.test(f) ? f.replace(mc, e) : f + " " + e);
        },
      }),
    kb(function () {
      kb.support.reliableMarginRight ||
        (kb.cssHooks.marginRight = {
          get: function (a, c) {
            return c
              ? kb.swap(a, { display: "inline-block" }, lc, [a, "marginRight"])
              : b;
          },
        }),
          ...
          kb.each(["top", "left"], function (a, c) {
            kb.cssHooks[c] = {
              get: function (a, d) {
                return d
                  ? ((d = lc(a, c)),
                    sc.test(d) ? kb(a).position()[c] + "px" : d)
                  : b;
              },
            };
          });
    ...
    kb.expr &&
      ...
      ((kb.expr.filters.hidden = function (a) {
        return (
          ...
          (!kb.support.reliableHiddenOffsets &&
            "none" === ((a.style && a.style.display) || kb.css(a, "display")))
        );
      }),
  ...
  kb.fn.extend({
    ...
    (kb.param = function (a, c) {
      ...
      if (
        (c === b && (c = kb.ajaxSettings && kb.ajaxSettings.traditional),
      ...
      ajax: function (a, c) {
        ...
        if (
          ...
          m.data &&
            ...
            (m.data = kb.param(m.data, m.traditional)),
          G(Qc, m, c, w),
          2 === u)
        )
          return w;
        (j = m.global),
          ...
          m.hasContent ||
            (m.data &&
              ((g = m.url += (Hc.test(g) ? "&" : "?") + m.data), delete m.data),
            m.cache === !1 &&
              (m.url = Jc.test(g)
                ? g.replace(Jc, "$1_=" + Gc++)
                : g + (Hc.test(g) ? "&" : "?") + "_=" + Gc++)),
          m.ifModified &&
            (kb.lastModified[g] &&
              w.setRequestHeader("If-Modified-Since", kb.lastModified[g]),
              ...
              i.send((c.hasContent && c.data) || null),
                ...
                c.async
                  ? 4 === i.readyState
                    ? setTimeout(d)
                    : ((g = ++Yc),
                      Zc && (Wc || ((Wc = {}), kb(a).unload(Zc)), (Wc[g] = d)),
      ...
      "*": [
        function (a, b) {
          var c = this.createTween(a, b),
            ...
            g =
              (kb.cssNumber[a] || ("px" !== f && +d)) &&
              bd.exec(kb.css(c.elem, a)),
            h = 1,
            i = 20;
          if (g && g[3] !== f) {
            (f = f || g[3]), (e = e || []), (g = +d || 1);
  ...
  (kb.Animation = kb.extend(O, {
      ...
      _default: {
        get: function (a) {
          ...
          return null == a.elem[a.prop] ||
            ...
            ? ((b = kb.css(a.elem, a.prop, "")), b && "auto" !== b ? b : 0)
            : a.elem[a.prop];
        },
        set: function (a) {
          kb.fx.step[a.prop]
            ? kb.fx.step[a.prop](a)
            : a.elem.style &&
              (null != a.elem.style[kb.cssProps[a.prop]] || kb.cssHooks[a.prop])
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            a && !kb.nodeName(a, "html") && "static" === kb.css(a, "position");
    ...
    kb.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (
      a,
      c
    ) {
      var d = /Y/.test(c);
    ...
    kb.each({ Height: "height", Width: "width" }, function (a, c) {
      kb.each({ padding: "inner" + a, content: c, "": "outer" + a }, function (
        d,
        e
      ) {
  ...
  (function (a, b, c) {
    ...
    var d = {
      ...
      f = function (c, e, f) {
        (this.options = a.extend({}, a.fn.backstretch.defaults, f || {})),
          ...
          (this.$container = a(c)),
          (this.$root = this.isBody ? a(g ? b : document) : this.$container),
    ...
    f.prototype = {
      resize: function () {
        try {
          ...
          g >= f
            ? ((a = (g - f) / 2),
              this.options.centeredY && (c.top = "-" + a + "px"))
            : ((g = f),
              (e = g * this.$img.data("ratio")),
              (a = (e - d) / 2),
              this.options.centeredX && (c.left = "-" + a + "px")),
            this.$wrap
              .css({ width: d, height: f })
              .find("img:not(.deleteable)")
              .css({ width: e, height: g })
              .css(c);
        } catch (h) {}
        return this;
      },
            ...
            (c.$img = a("<img />")
              ...
              .bind("load", function (e) {
                ...
                (e = this.height || a(e.target).height()),
                  ...
                  a(this).fadeIn(
                    c.options.speed || c.options.fade,
                    function () {
                      d.remove(),
                        c.paused || c.cycle(),
                        a(["after", "show"]).each(function () {
                          c.$container.trigger(
                            a.Event("backstretch." + this, f),
                            [c, b]
                          );
                        });
                    }
    ...
    g = !(
      ...
      (l && 7458 > m) ||
      (-1 < h.indexOf("Android") && j && 533 > j) ||
      (k && 6 > k) ||
      ("palmGetResource" in b && j && 534 > j) ||
      (-1 < h.indexOf("MeeGo") && -1 < h.indexOf("NokiaBrowser/8.5.0")) ||
      (n && 6 >= n)
    );
  })(jQuery, window),
  (function (a, b, c, d) {
    ...
    c.extend(h, {
              ...
              "object" === c.type(f) &&
                ...
                l(f)
                  ? ((o = {
                    ...
                    c.metadata && c.extend(!0, o, f.metadata()))
                  : (o = f)),
                ...
                !k &&
                  ...
                  k ||
                    (k = (k = f.prop("class").match(/fancybox\.(\w+)/))
                      ? k[1]
                      : null)),
                m(g) &&
                  (k ||
      ...
      _start: function (a) {
        ...
        if (
          ...
          if (
            ((h.isActive = !0),
            ("image" === d || "swf" === d) &&
              ((e.autoHeight = e.autoWidth = !1), (e.scrolling = "visible")),
      ...
      _afterLoad: function () {
        ...
        if ((h.hideLoading(), g && !1 !== h.isActive))
          if (!1 === h.trigger("afterLoad", g, i))
            g.wrap.stop(!0).trigger("onReset").remove(), (h.coming = null);
          else {
            switch (
              (i &&
                (h.trigger("beforeChange", i),
                i.wrap
                  .stop(!0)
                ...
                g.selector
                  ...
                  : l(a) &&
                    ...
                    g.wrap.bind("onReset", function () {
                      c(this).find(a).length &&
                        a
                          .hide()
                          .replaceAll(a.data("fancybox-placeholder"))
            ...
            (!l(a) || !a.parent().is(g.inner)) && g.inner.append(a),
              ...
              h.bindEvents(),
              h.isOpened
                ? i.prevMethod && h.transitions[i.prevMethod]()
                : c(".fancybox-wrap")
                    .not(g.wrap)
                    .stop(!0)
                    .trigger("onReset")
      ...
      _setDimension: function () {
        ...
        if (
          ...
          if (((k = u.content), u.autoHeight && 1 === k.data("ready")))
            try {
              k[0].contentWindow.document.location &&
                (t.width(e).height(9999),
                (g = k.contents().find("body")),
                B && g.css("overflow-x", "hidden"),
                (f = g.outerHeight(!0)));
            } catch (F) {}
        } else
          (u.autoWidth || u.autoHeight) &&
            (t.addClass("fancybox-tmp"),
        ...
        if (
          ...
          (i = z),
          u.fitToView &&
            ((y = Math.min(l.w - b, y)), (z = Math.min(l.h - d, z))),
          (b = l.w - D),
          (E = l.h - E),
          u.aspectRatio
            ? (r > y && ((r = y), (v = o(r / j))),
              ...
              w > r && ((r = w), (v = o(r / j))),
              x > v && ((v = x), (r = o(v * j))))
            : ((r = Math.max(w, Math.min(r, y))),
              u.autoHeight &&
                "iframe" !== u.type &&
                (t.width(r), (v = t.height())),
      ...
      g.ready(function () {
        ...
        if (
          ...
          (b = c.support),
            (f = c('<div style="position:fixed;top:20px;"></div>').appendTo(
              "body"
            ));
    ...
    b.helpers.media = {
      defaults: {
        ...
        metacafe: {
          ...
          url: function (b, c, d) {
            return (
              (d.swf.flashVars = "playerVars=" + a.param(c, !0)),
          ...
          if (b.hasOwnProperty(e) && ((f = b[e]), (g = i.match(f.matcher)))) {
            (j = f.type),
              (h = a.extend(
                ...
                {},
                f.params,
                d[e] || (a.isPlainObject(b[e]) ? b[e].params : null)
              )),
              (i =
                "function" === a.type(f.url)
                  ? f.url.call(this, g, h, d)
                  : c(f.url, g, h));
            break;
          }
        ...
        for (
          ...
          if (m >= b)
            ...
            var n =
              ...
              b -
              i;
            0 > n ? (n += k.topSpacing) : (n = k.topSpacing),
              k.currentTop != n &&
  ...
  $(function () {
    $("header").backstretch(
      [
        "/assets/media/ADAM_LIGHTS.jpg",
        "/assets/media/ALYSSA_MIZ_SOUND.jpg",
        "/assets/media/CAM_JER_FILMING.jpg",
        "/assets/media/JER_EDITING.jpg",
      ],
      { duration: 5e3, fade: 750 }
    ),
      $(".int_thumb").fancybox({ padding: 6, arrows: !1, closeBtn: !1 }),
      $(".promo_vid").fancybox({
        padding: 6,
        arrows: !1,
        closeBtn: !1,
    ...
    var a = $(window).width();
    a > 571 && 740 > a && $(".apply_wrapper").sticky({ topSpacing: 20 }),
      $(window).resize(function () {
        var a = $(".sticky-wrapper").length,
          b = $(window).width();
        !a &&
          b > 571 &&
          740 > b &&
          $(".apply_wrapper").sticky({ topSpacing: 20 });
      });
  });
